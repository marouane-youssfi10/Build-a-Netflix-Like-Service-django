...
class TVShowProxyModelTestCase(TestCase):
    def create_show_with_seasons(self):
        ...
        self.season_1 = TVShowSeasonProxy.objects.create(title='The Office Series Season 1',
                                                         state=PublishStateOptions.PUBLISH, parent=the_office, order=1)
        ...
        self.season_11 = TVShowSeasonProxy.objects.create(title='The Office Series Season 1', parent=the_office,
                                                          order=4)
    ...
    def setUp(self):
        ...
        obj_b = TVShowProxy.objects.create(title='This is my title', state=PublishStateOptions.PUBLISH,
                                           video=self.video_a)
